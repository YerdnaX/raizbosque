        ...
        <ImageBackground source={require('@/assets/images/login/inicio.png')} style={estilos.fondo} resizeMode="cover">
            <View style={[estilos.contenedor, { paddingTop: Math.max(20, insets.top) }]}>
                <View style={estilos.tarjeta}>
                    <Image source={require('@/assets/images/iconosv2/exitorecuperacion.png')} style={estilos.icono} />
                    <Text style={estilos.titulo}>{t('auth.recoverPassword.completed.title')}</Text>
                    <Text style={estilos.subtitulo}>
                        {t('auth.recoverPassword.completed.message')}
                    </Text>
                    ...
                    >
                        <Text style={estilos.botonTexto}>{t('auth.recoverPassword.completed.login')}</Text>
                    </Pressable>
                </View>
            </View>
        </ImageBackground>
